  ...
  return (
    <div className="bg-[var(--card-bg)] p-6 rounded-lg shadow-md">
      ...
      <div className="mb-8">
        ...
        <ul className="relative z-0 border-l-3 border-[var(--accent)] pl-6 ml-4 space-y-6">
          {/* List Item */}
          <li className="relative">
            <div className="absolute -left-8 top-1 w-3 h-3 bg-[var(--accent)] rounded-full border-2 border-white"></div>
            <div>
